...
export default function BorderProgressBar({
  ...
  const sectionFourCoveredHeight = Math.min(
    Math.max(
      coveredDistance - sectionOneWidth - sectionTwoHeight - sectionThreeWidth,
      0,
    ),
    sectionFourHeight,
  );
  ...
  console.log({
    ...
    totalDistance,
    coveredDistance,
    sectionOneCoveredWidth,
    sectionTwoCoveredHeight,
    sectionThreeCoveredWidth,
    sectionFourCoveredHeight,
    sectionFiveCoveredWidth,
  });
